...
with DAG(
    ...
    landing_to_bronze = SparkSubmitOperator(
        ...
        application="/ Users / oksana / Workspace / Data - Engineering / goit_de_fp /landing_to_bronze.py",
        conn_id="spark-default",
        verbose=1,
    )
    ...
    bronze_to_silver = SparkSubmitOperator(
        ...
        application="/ Users / oksana / Workspace / Data - Engineering / goit_de_fp /bronze_to_silver.py",
        conn_id="spark-default",
        verbose=1,
    )
    ...
    silver_to_gold = SparkSubmitOperator(
        ...
        application="/ Users / oksana / Workspace / Data - Engineering / goit_de_fp /silver_to_gold.py",
        conn_id="spark-default",
        verbose=1,
    )
