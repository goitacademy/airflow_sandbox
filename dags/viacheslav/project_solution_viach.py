...
landing_to_bronze_task = SparkSubmitOperator(
    application='/opt/airflow/dags/viacheslav/landing_to_bronze_viach.py',
...
bronze_to_silver_task = SparkSubmitOperator(
    application='/opt/airflow/dags/viacheslav/bronze_to_silver_viach.py',
...
silver_to_gold_task = SparkSubmitOperator(
    application='/opt/airflow/dags/viacheslav/silver_to_gold_viach.py', 
