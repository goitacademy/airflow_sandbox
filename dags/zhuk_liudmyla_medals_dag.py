...
def _generate_delay():
    # Тимчасово sleep=5 < 30 с (порога сенсора), щоб зняти скрин успішного
    # сценарію (06_grid_success_sensor.png). Після скрина поверну 35.
    print("Засинаємо на 5 секунд (швидкий сценарій для скрина успіху).")
    time.sleep(5)
